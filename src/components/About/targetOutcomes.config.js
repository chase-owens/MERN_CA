const targetOutcomes = [
  ...
  {
    title: `Pleasant Interaction`,
    steps: [
      { icon: 'A', description: 'You sit on couch' },
      { icon: 'B', description: 'Dog comes over and sits next to you' },
      { icon: 'C', description: `Y'all hang out and watch TV` }
    ]
  },
  {
